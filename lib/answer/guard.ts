...
const limitationPattern = /(確認が必要|未確定|未定|(?:確認|判断)でき(?:ていない|ていません|ない|ません)|(?:記録|情報)(?:が|は)(?:ない|ありません|見つからない|見つかりません|確認でき(?:ない|ません|ていない|ていません)|不足)|不明|未確認|分からない|わからない|分かりません|わかりません|(?:まだ)?決まってい(?:ない|ません)|本人(?:が|の)(?:判断|決定|決める)|(?:面談|本人)(?:で|に)?[^。]{0,12}(?:確認|聞|尋ね)[^。]{0,6}ください)/;
