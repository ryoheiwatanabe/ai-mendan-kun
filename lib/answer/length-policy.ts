...
const overviewExperience =
  /(?:これまで|今まで)(?:の)?(?:経験|仕事|キャリア|職歴|経歴|活動)(?:を|は|って)?(?:教えて|聞かせて|知りたい|まとめて|振り返って|どんな感じ)?(?:ください|下さい)?[?？]?$|(?:これまで|今まで)に?(?:担当|関わ)った?(?:役割|仕事|業務|プロジェクト)|どんな(?:経験|仕事|職歴|経歴)(?:を)?(?:してきた|されてきた|してきました|されてきました)/u;
