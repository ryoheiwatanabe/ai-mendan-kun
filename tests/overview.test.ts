...
test("経歴全体の概要を求める発言だけを完全消費で判定する", () => {
  for (const question of [
    ...
    // 言語の指定は外して同じ日本語の概要を返す。
    "経歴を英語で説明してください", "自己紹介を英語でお願いします", "これまでの経歴をEnglishで教えてください",
    // 音声認識の空白区切りと冒頭の言い淀み、敬語の「ご経歴」も概要の依頼として扱う。
    "え まず あなた の ご 経歴 を お 願い し ます", "あなたのご経歴をお願いします", "ご経歴を教えてください",
    "え あなた の こう 経歴 を お 願い し ます", "えっと あなた の その 経歴 を 教えて ください",
    "これまでの歩みを教えてください", "今までの道のりを教えてください",
    "あー、あなたのご略歴を簡単に教えてください",
    // 対象の前に「どんな」が入る自然な聞き方も概要の依頼として扱う。
    "これまでどんな仕事をしてきましたか", "今までどんな仕事をしてきたんですか", "どんな仕事をされてきましたか",
  ...
  for (const question of [
    ...
    "英語で仕事をした経験を教えて",
    "どんな仕事でも対応できますか", "その会社の経歴を教えてください", "あなたの会社の経歴を教えてください",
