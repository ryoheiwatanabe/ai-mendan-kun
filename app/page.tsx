  ...
  return <main className="shell">
    ...
    <div className="workspace">
      <aside className="intro">
        <div className="intro-main"><p className="intro-caption">面談までの、もうひとつの対話。</p><h1>会う前に、<br />少し話そう。</h1><p className="intro-copy">経歴だけでは、伝わらないこと。<br />任せたい仕事や、気になる考え方。<br />本人の記録をもとに、AIがお答えします。</p></div>
