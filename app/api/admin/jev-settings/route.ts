...
const messages: Record<string, string> = {
  ...
  invalid_jev_beam: "ビーム探索の設定を確認してください。",
  invalid_jev_beam_width: "同時に残す候補ルート数は、1巡で評価する候補ルート数より大きくできません。",
  invalid_jev_beam_judgments: "候補ルート×2判定が、段階内の判定数を超えています。候補ルート数を減らすか、段階内の判定数を増やしてください。",
