...
事実の文章は承認済みの完全な段落から選び、自己紹介では経歴・活動を先に紹介します。名前の確認には、同じ承認済み見出しと固有名詞一覧で照合できる名前を短く返します。見出しから現在の肩書や担当を推測しません。数字や担当範囲を保持しやすい一方、本文の回答が長く硬くなることはあり、自由な言い換えは今後の改善対象です。
